module.exports = function (fields, fileName) {
  return `<a class="shareBtn" href="https://twitter.com/intent/tweet?text=${ fields.title } https://www.stefanjudis.de/${ fileName }">
