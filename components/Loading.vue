      ...
      <nuxt-link :to="'/'" aria-label="Home" :class="[loading ? 'is-loading': '']">
        ...
        >
          ...
          <g fill-rule="nonzero" fill="none">
            ...
            <use fill="url(#c)" fill-rule="evenodd" xlink:href="#b"></use>
          </g>
        </svg>
      </nuxt-link>
    </div>
